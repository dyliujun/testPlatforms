...
class TestdataFlowNew(models.Model):
    ...
    swagger_url = models.CharField(max_length=500)
    ...
    class Meta:
        managed = False
        db_table = 'testdata_flow_new'

class TestdataNodeNew(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'testdata_node_new'

class TestenvNew(models.Model):
